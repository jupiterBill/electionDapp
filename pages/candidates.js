...
useEffect(()=>{setNewOwner("0xc5BF15B6965B6D796F8B56FfC6A6C0C2499bb6FF");},[])

//setNewOwner("0xc5BF15B6965B6D796F8B56FfC6A6C0C2499bb6FF");
  // //
      ...
      {isCandidateListed ? <CandidateTable shortlistedNames={reviewItem} /> : (
        ...
        <div className={Style.review}>
          ...
          <div className={Style.reviewButtons}>
            ...
            <Button btnName="Transfer" handleClick={()=>{transferOwnership(newOwner)}}/>
